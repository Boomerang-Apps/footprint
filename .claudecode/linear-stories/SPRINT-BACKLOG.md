...
**Story Points**: 10/19 (In Progress)
**Started**: 2025-12-25

| ID | Story | Acceptance Criteria | SP | Priority | Agent | Status |
|----|-------|--------------------|----|----------|-------|--------|
| OM-01 | Admin order dashboard | Order list, filter by status, search by # | 3 | Must | Frontend-B | ✅ Done |
| OM-02 | Update order status | Status dropdown, timestamp logged, customer notified | 2 | Must | Backend-2 | ✅ Done |
...
| CO-03 | Apple Pay / Google Pay | Wallet detection, one-tap payment, same confirmation | 3 | Should | Backend-2 | ✅ Done |
